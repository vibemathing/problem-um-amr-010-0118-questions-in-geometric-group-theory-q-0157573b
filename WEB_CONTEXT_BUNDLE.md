...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0118-questions-in-geometric-group-theory-q-0157573b",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0118-3a38176f34c1",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0118"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Epstein) Let $G$ be a word-hyperbolic group and $\\partial G$ its boundary. Is there an algorithm to compute $\\check H^i(\\partial G)\\cong H^{i+1}(G,\\mathbb{Z}G)$? In particular, is there an algorithm to decide whether $\\check H^i(\\partial G)\\cong\\check H^i(S^2)$ for all $i$?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 1.18",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "8b80d0c60b2f04890840a6d5e165e5d85bf6ea0afac6574951b98c9b2bbb9e2b"
}
```
